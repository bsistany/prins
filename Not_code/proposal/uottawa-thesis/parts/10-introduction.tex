...
\lstset{mathescape, language=AST}  
\begin{lstlisting}[frame=single, caption={Policy Translation {$\colon$} PrimitivePolicySet},label={lst:transpolicyformulaPrimitivePolicySet}]
...
\lstset{mathescape, language=AST}  
\begin{lstlisting}[frame=single, caption={Policy Translation {$\colon$} PrimitiveExclusivePolicySet},label={lst:transpolicyformulaPrimitiveExclusivePolicySet}]
...
\lstset{mathescape, language=AST}  
\begin{lstlisting}[frame=single, caption={Policy Translation {$\colon$} AndPolicySet},label={lst:transpolicyformulaAndPolicySet}]
...
\lstset{language=Coq, frame=single, caption={Translation of a positive policy},label={lst:transpolicypositive}}
\begin{lstlisting}

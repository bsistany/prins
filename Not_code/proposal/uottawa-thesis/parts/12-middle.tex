...
Translation of a \emph{policySet} takes as input $prin_{u}$, the agreement's user, and $a$, the asset, and proceeds by case analysis of different policySet constructors and recursing into translation functions for the composing elements. A policySet is either a \emph{PrimitivePolicySet}, \emph{PrimitiveExclusivePolicySet} or a \emph{AndPolicySet}. 
